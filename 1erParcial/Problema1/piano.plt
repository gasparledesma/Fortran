...
# G11: 1 -> i -> 2
G11(w_sq, x_param) = 1.0 / (w_sq - w1 + i*eta - (V1i*Vi1 / (w_sq - wi + i*eta_i - (V2i*Vi2 / (w_sq - pos_w2(x_param) + i*eta)))))

# Gii: i conectado a 1 y 2
Gii(w_sq, x_param) = 1.0 / (w_sq - wi + i*eta_i - (Vi1*V1i / (w_sq - w1 + i*eta)) - (Vi2*V2i / (w_sq - pos_w2(x_param) + i*eta)))

# G22: 2 -> i -> 1
G22(w_sq, x_param) = 1.0 / (w_sq - pos_w2(x_param) + i*eta - (V2i*Vi2 / (w_sq - wi + i*eta_i - (V1i*Vi1 / (w_sq - w1 + i*eta)))))
...
set output "piano_sincronizacion.pdf"
replot
unset output