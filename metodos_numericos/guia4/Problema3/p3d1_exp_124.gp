...
set title "Error en la primera derivada orden 2 y 4 de f(x) = x * exp(x) en x = 2"

set logscale x
set logscale y

fName1 = "./datos/p3-exp-1.dat"
fName2 = "./datos/p3-exp-2.dat"
fName3 = "./datos/p3-exp-3.dat"
...
set output "grafs/p3-exp-all.png"
